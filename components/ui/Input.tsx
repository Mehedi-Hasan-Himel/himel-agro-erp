    ...
    return (
      <div className="w-full space-y-1.5">
        ...
        <input
          ...
          ref={ref}
          className={cn(
            "w-full rounded-xl border bg-white px-3.5 py-2 text-sm text-slate-900 placeholder-slate-500 transition-colors focus:border-emerald-600 focus:outline-hidden focus:ring-2 focus:ring-emerald-500/25 disabled:bg-slate-100 disabled:text-slate-500",
